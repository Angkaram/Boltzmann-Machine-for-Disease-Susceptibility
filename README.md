...
4. August 4, 2024: I have added extractions to the code, making it possible to visualize the data. Specifically, I used t-SNE reduction to reduce the multi-dimensional data into a nice 2D plot. I also expand on my work in essay format, which can be found below.
5. August 16, 2024: Overhaul of the readme.md for elaboration, analysis, and rationale. Added visuals that can be observed when running the main code.
